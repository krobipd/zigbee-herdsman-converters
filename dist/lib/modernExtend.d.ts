...
import type { Access, BatteryLinearVoltage, BatteryNonLinearVoltage, Configure, ElementOf, Fz, KeyValue, LevelConfigFeatures, ModernExtend, PowerSource, Range, Tz, Zh } from "./types";
...
export declare function setupConfigureForReading<Cl extends string | number, Custom extends TCustomCluster | undefined = undefined>(cluster: Cl, attributes: ClusterOrRawAttributeKeys<Cl, Custom>, endpointNames?: string[], options?: Record<string, unknown>): Configure;
...
export declare function identify(args?: IdentifyArgs): ModernExtend;
...
export declare function fanControl<Cl extends string | number = "hvacFanCtrl", Custom extends TCustomCluster | undefined = undefined>(args?: FanControlArgs<Cl, Custom>): ModernExtend;
...
export declare function thermostatUi<Cl extends string | number = "hvacUserInterfaceCfg", Custom extends TCustomCluster | undefined = undefined>(args?: ThermostatUiArgs<Cl, Custom>): ModernExtend;
...
export declare function iasGetPanelStatusResponse(options?: {
    audiblenotif?: number;
}): ModernExtend;
...
export declare function windSpeed(args?: Partial<NumericArgs<"msWindSpeed">>): ModernExtend;
...
export declare function customLocalTemperatureCalibrationRange({ min, max }: {
    min: number;
    max: number;
}): ModernExtend;
...
export type IasZoneType = "occupancy" | "contact" | "smoke" | "water_leak" | "rain" | "pressure" | "carbon_monoxide" | "sos" | "vibration" | "alarm" | "gas" | "generic";
...
export declare function deviceAddCustomCluster(clusterName: string, clusterDefinition: Cluster): ModernExtend;
...
declare const SETPOINT_LIMIT_LOOKUP: {
    readonly maxHeatSetpointLimit: {
        readonly tzConverter: Tz.Converter;
        readonly expose: (min: number, max: number, step: number) => Numeric;
    };

    ...
    alarmControl: () => {
        ...
        const exposes = [
            e
                ...
                .withDescription("Manually controls the alarm siren of the device. Set to 'smoke' or 'burglar' to activate the " +
                ...
                convertSet: async (entity, key, value, meta) => {
                    if (key === "alarm_control") {
                        ...
                        if (value === "off") {
                            ...
                            const alarmModesToStop = typeof activeAlarm === "string" && activeAlarm in alarmModeLookup
                                ? [alarmModeLookup[activeAlarm]]
...
exports.boschThermostatExtend = {
    ...
    humidityAlarmLed: () => m.binary({
        name: "humidity_alarm_led",
        cluster: "hvacThermostat",
        attribute: "humidityAlarmLed",
        description: "Enables/disables the LED warning when measured humidity is outside the comfortable range " +

...
export declare const circuitBreakerFaultList: string[];
...
export declare function convertBufferToNumber(chunks: Buffer | number[], signed?: boolean): number;
...
declare const tuyaExposes: {
    alarmTime: () => exposes.Numeric;
    alarmMode: () => exposes.Enum;
    alarmStatus: () => exposes.Enum;
    dismissAlarm: () => exposes.Enum;
    sensitivity: () => exposes.Enum;
    ...
    inchingSwitch2: () => exposes.Composite;
    circuitBreakerFaults: () => exposes.List;
    circuitBreakerStatus: () => exposes.Enum;
    leakageCurrent: () => exposes.Numeric;
    reclosing: () => exposes.Binary;
    reclosing_delay: () => exposes.Numeric;
    reclosing_count: () => exposes.Numeric;
    energyPrepayment: () => exposes.Binary;
    energyBalance: () => exposes.Numeric;
    energyBalanceAdd: () => exposes.Numeric;
    energyBalanceReset: () => exposes.Enum;
    energyReset: () => exposes.Enum;
    leakageCurrentAndTemperatureAlarm: () => exposes.Composite;
    rs485ConfigAndHighPowerAlarm: () => exposes.Composite;
    currentAndVoltageAlarm: () => exposes.Composite;
    alarmSet2: () => exposes.Composite;
    overCurrentThresholdTime: () => exposes.Numeric;
    lostFlowAlarm: () => exposes.Composite;
    lostFlowThresholdTime: () => exposes.Numeric;
    liquidLevelPercent: () => exposes.Numeric;
    liquidDepth: () => exposes.Numeric;
    liquidDepthMax: () => exposes.Numeric;
    liquidInstallationHeight: () => exposes.Numeric;
    liquidMinimalPercent: () => exposes.Numeric;
    liquidMaximalPercent: () => exposes.Numeric;
    liquidState: () => exposes.Enum;
    powerSupplyVoltage: () => exposes.Numeric;
    relaySwitch: () => exposes.Binary;
    pumpMode: () => exposes.Enum;
    autoPumpControl: () => exposes.Enum;
    version: () => exposes.Text;
    alarmDuration: () => exposes.Numeric;
    coverPosition: () => exposes.Cover;
    motorState: () => exposes.Enum;
    motorDirection: () => exposes.Enum;
    motorDirectionSide: () => exposes.Enum;
    slowMode: () => exposes.Binary;
    coverType: () => exposes.Enum;
    favoritePosition: () => exposes.Numeric;
    coverLimit: () => exposes.Enum;
    clickControl: () => exposes.Enum;
};
export { tuyaExposes as exposes };
declare const tuyaOptions: {
    timeStart: (defaultOption: string) => exposes.Enum;
};
...
export declare const valueConverter: {
    ...
    tubularMotorDirection: {
        from: (v: number | string, meta: Fz.Meta, options: KeyValue) => string | number | boolean | KeyValue;
        to: (v: string, meta: Tz.Meta) => string | number | boolean | Enum;
    };
    motorDirectionSide: {
        to: (v: string, meta: Tz.Meta) => string | number | boolean | Enum;
    ...
    onOffWithZeros: {
        to: (v: string) => boolean;
        from: (v: boolean, meta: Fz.Meta, options: KeyValue, publish: Publish) => string;
    };
    onOffFingerbot: {
        to: (v: string) => boolean;
        from: (v: boolean, meta: Fz.Meta, options: KeyValue, publish: Publish) => "OFF" | "ON";
    };
    power: {
        from: (v: number) => number;
    };
    ...
    threshold_4: {
        from: (v: Buffer) => Record<string, string | number>;
        to: (v: AlarmSet1Input, meta: AlarmSet1MetaState) => number[];
    };
    threshold_5: {
        from: (v: Buffer) => Record<string, string | number>;
        to: (v: AlarmSet2Input, meta: AlarmSet2MetaState) => number[];
    };
    threshold_6: {
        from: (v: Buffer) => Record<string, string | number>;
        to: (v: AlarmSet3Input, meta: AlarmSet3MetaState) => number[];
    };
    threshold_7: {
        from: (v: Buffer) => Record<string, string | number>;
        to: (v: AlarmSet1BInput, meta: AlarmSet1BMetaState) => number[];
    };
    threshold_8: {
        from: (v: Buffer) => Record<string, string | number>;
        to: (v: AlarmSet2Input, meta: AlarmSet2MetaState) => number[];
    ...
    tv02Preset: () => {
        from: (v: number) => "auto" | "holiday" | "manual";
    ...
    onOffNotStrict: {
        from: (v: string) => "OFF" | "ON";
        to: (v: string) => v is "ON";
    };
    errorOrBatteryLow: {
        from: (v: number, meta: Fz.Meta, options: KeyValue, publish: Publish) => boolean;
    };
    inchingSwitch: {
    ...
    inchingSwitch2: {
        to: (value: InchingInput, meta: InchingMetaState) => string;
    ...
    GX03ValveState: (zoneNum: number) => {
        from: (value: unknown, meta: Fz.Meta, options: KeyValue, publish: Publish) => string;
    };
    autoAdjustment: {
        to: (v: string) => v is "START";
        from: (v: boolean) => string;
    };
    switchStates: {
        to: (v: string, meta: Tz.Meta) => boolean;
        from: (v: boolean) => string;
    };
};
declare const tuyaTz: {
    ...
    TS110E_light_onoff_brightness: {
        ...
        endpoints?: string[];
        convertGet?: (entity: Zh.Endpoint | Zh.Group, key: string, meta: Tz.Meta) => Promise<Tz.ConvertSetResult>;
        convertSet: (entity: import("zigbee-herdsman/dist/controller/model").Endpoint | import("zigbee-herdsman/dist/controller/model").Group, key: string, value: unknown, meta: Tz.Meta) => Promise<Tz.ConvertSetResult>;
    };
    cover_reversal: {
        key: string[];
...
declare const tuyaFz: {
    ...
    TS110E: {
        cluster: "genLevelCtrl";
        type: ["attributeReport", "readResponse"];
        convert: (model: import("./types").Definition, msg: Fz.Message<"genLevelCtrl", undefined, ["attributeReport", "readResponse"]>, publish: Publish, options: KeyValue, meta: Fz.Meta) => KeyValue;
    };
    TS110E_light_type: {
        cluster: "genLevelCtrl";
        type: ["attributeReport", "readResponse"];
    ...
    ts0216_siren: {
        cluster: "ssIasWd";
        type: ["attributeReport", "readResponse"];
        convert: (model: import("./types").Definition, msg: Fz.Message<"ssIasWd", undefined, ["attributeReport", "readResponse"]>, publish: Publish, options: KeyValue, meta: Fz.Meta) => KeyValueAny;
    };
    /** Continues tuyaFirmwareId configuration */
    mcu_version: {
        cluster: "manuSpecificTuya";
        type: ["commandMcuVersionResponse"];
        convert: (model: import("./types").Definition, msg: Fz.Message<"manuSpecificTuya", undefined, ["commandMcuVersionResponse"]>, publish: Publish, options: KeyValue, meta: Fz.Meta) => void;
    };
};
export { tuyaFz as fz };
...
declare const tuyaModernExtend: {
    ...
    tuyaCoverSwitchType: (args?: Partial<modernExtend.EnumLookupArgs<"closuresWindowCovering">>) => ModernExtend;

...
exports.clusters = exports.modernExtend = exports.fz = exports.tz = exports.valueConverter = exports.valueConverterBasic = exports.Bitmap = exports.BacklightColorEnum = exports.enum = exports.Enum = exports.whitelabel = exports.fingerprint = exports.configureBindBasic = exports.configureQuery = exports.configureMagicPacket = exports.skip = exports.options = exports.exposes = exports.TuyaWeatherID = exports.F3ProTuyaWeatherCondition = exports.M8ProTuyaWeatherCondition = exports.dataTypes = exports.circuitBreakerFaultList = void 0;
 ...
 */
function decodeTuyaVersion(value) {
    const major = value >> 6;
...
exports.valueConverter = {
    ...
    tubularMotorDirection: (() => {
        const converter = exports.valueConverterBasic.lookup({
            normal: new Enum(0),
            reversed: new Enum(1),
        });
        return {
 ...
 */
const tuyaFirmwareId = async (device) => {
...
const tuyaModernExtend = {
    ...
    tuyaBase(args = {}) {
        const { dp = false, queryOnDeviceAnnounce = false, queryOnConfigure = false, bindBasicOnConfigure = false, queryIntervalSeconds = undefined, 
        // Allow force updating for device with a very bad clock
        // Every hour when a message is received the time will be updated.
        forceTimeUpdates = false, timeStart = "off", } = args;
        const fzConverter = {
            type: [
                "commandMcuSyncTime",
            ...
            convert: (model, msg, publish, options, meta) => {
                ...
                const timeStartOption = options.time_start;
                if (timeStartOption) {
                    if (["1970", "2000", "off"].includes(timeStartOption)) {
                        selectedTimeStart = timeStartOption;
                    }
                    else {
                        logger_1.logger.warning(`Invalid option "${timeStartOption}" for ${meta.device.ieeeAddr}.time_start, using default`, NS);
                    }
                }
            ...
            result.onEvent = [
                (event) => {
                    ...
                    if (event.type === "deviceAnnounce") {
                        const shouldQuery = typeof queryOnDeviceAnnounce === "function" ? queryOnDeviceAnnounce(event.data.device) : queryOnDeviceAnnounce;
                        if (shouldQuery) {
    ...
    tuyaWeatherForecast(args = {}) {
        ...
        function _prepareTuyaWeatherSyncPayload(meta, numberOfForecastDays, includeCurrentWeather) {
            ...
            for (let i = 1; i <= numberOfForecastDays; ++i) {
                ...
                weather_values[TuyaWeatherID.Humidity].push(`humidity_${i}` in meta.state ? meta.state[`humidity_${i}`] : 0);

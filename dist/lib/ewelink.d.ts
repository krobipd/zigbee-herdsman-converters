...
export declare const ewelinkFromZigbee: {
    motor_direction: {
        ...
        convert: (model: import("./types").Definition, msg: Fz.Message<"closuresWindowCovering", undefined, ["attributeReport", "readResponse"]>, publish: import("./types").Publish, options: import("./types").KeyValue, meta: Fz.Meta) => KeyValueAny;
    };
};

...
import type { BatteryLinearVoltage, BatteryNonLinearVoltage, Configure, Definition, DummyDevice, Expose, Fz, KeyValue, KeyValueAny, PowerSource, Publish, Tz, Zh } from "./types";
...
export declare function attachOutputCluster(device: Zh.Device, endpoint: Zh.Endpoint, clusterKey: string): void;
...
export declare function getFromLookup<V>(key: unknown, lookup: Record<string | number, V>, defaultValue?: V, keyIsBool?: boolean): V;
export declare function getFromLookupByValue(value: unknown, lookup: Record<string, unknown>, defaultValue?: string): string;
export declare function configureSetPowerSourceWhenUnknown(powerSource: PowerSource): Configure;
...
export declare function getEndpointsWithCluster(device: Zh.Device, cluster: string | number, type: "input" | "output"): import("zigbee-herdsman/dist/controller/model").Endpoint[];
export {};

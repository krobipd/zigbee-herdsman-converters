...
exports.ubisysModernExtend = {
    pollCurrentSummDelivered: (endpointId) => {
        return m.poll({
            key: "measurement",
    ...
    addCustomClusterHvacThermostat: () => (0, modernExtend_1.deviceAddCustomCluster)("hvacThermostat", {
        ...
        attributes: {
            ...
            ubisysInstalledExtensions: {
                ...
                ID: 0x0007,
                type: zigbee_herdsman_1.Zcl.DataType.BITMAP64,
                manufacturerCode: zigbee_herdsman_1.Zcl.ManufacturerCode.UBISYS_TECHNOLOGIES_GMBH,
                write: true,
            },
            // H1
    ...
    addCustomClusterClosuresWindowCovering: () => (0, modernExtend_1.deviceAddCustomCluster)("closuresWindowCovering", {
        ...
        attributes: {
            ...
            operationalStatus: { name: "operationalStatus", ID: 0x000a, type: zigbee_herdsman_1.Zcl.DataType.BITMAP8 },
        },
        commands: {},
        commandsResponse: {},
    }),
    addCustomClusterManuSpecificUbisysDeviceSetup: () => (0, modernExtend_1.deviceAddCustomCluster)("manuSpecificUbisysDeviceSetup", {
        ...
        attributes: {
            inputConfigurations: { name: "inputConfigurations", ID: 0x0000, type: zigbee_herdsman_1.Zcl.DataType.ARRAY, write: true },
            inputActions: { name: "inputActions", ID: 0x0001, type: zigbee_herdsman_1.Zcl.DataType.ARRAY, write: true },
            // LD6 only. Absent on other Ubisys devices, which simply never report them.
            outputConfigurations: { name: "outputConfigurations", ID: 0x0010, type: zigbee_herdsman_1.Zcl.DataType.ARRAY, write: true },
            outputEndpoints: { name: "outputEndpoints", ID: 0x0011, type: zigbee_herdsman_1.Zcl.DataType.BITMAP16 },
        },
        commands: {},
        commandsResponse: {},
    }),
    addCustomClusterManuSpecificUbisysDimmerSetup: () => (0, modernExtend_1.deviceAddCustomCluster)("manuSpecificUbisysDimmerSetup", {
        ...
        manufacturerCode: zigbee_herdsman_1.Zcl.ManufacturerCode.UBISYS_TECHNOLOGIES_GMBH,
        attributes: {
            capabilities: { name: "capabilities", ID: 0x0000, type: zigbee_herdsman_1.Zcl.DataType.BITMAP8, write: true },
            status: { name: "status", ID: 0x0001, type: zigbee_herdsman_1.Zcl.DataType.BITMAP8, write: true },
            mode: { name: "mode", ID: 0x0002, type: zigbee_herdsman_1.Zcl.DataType.BITMAP8, write: true },
        },
        commands: {},
        commandsResponse: {},
    }),
    ...
    vacationMode: () => {
        ...
        const configure = [
            (0, modernExtend_1.setupConfigureForReporting)(clusterName, readableAttributeName, { config: { min: 0, max: "1_HOUR", change: 0 }, access }),
        ];
    ...
    operationalStatus: (args) => (0, modernExtend_1.enumLookup)({
        name: "motor_state",
        cluster: "closuresWindowCovering",
        attribute: "operationalStatus",
        entityCategory: "diagnostic",
        description: "This attribute contains two bits which will be set while the motor is active. " +

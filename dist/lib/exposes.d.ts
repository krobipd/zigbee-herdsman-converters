import type { ThermostatAcLouverPosition, ThermostatControlSequenceOfOperation, ThermostatFanMode, ThermostatProgrammingOperationMode, ThermostatRunningMode, ThermostatRunningState, ThermostatScheduleMode, ThermostatSystemMode } from "./constants";
...
export declare class Base {
    ...
    withHomeAssistant(homeassistant: HomeAssistant): this;
...
export declare class Switch extends Base {
    type: "switch";
    features: Feature[];
    withState(property: string, toggle: string | boolean, description: string, access?: Access, valueOn?: string, valueOff?: string): this;
    clone(): Switch;
}
...
export declare class Light extends Base {
    ...
    withLevelConfig(features?: LevelConfigFeatures): this;
...
export declare class Fan extends Base {
    type: "fan";
    features: Feature[];
    withState(name?: string, access?: Access): this;
    withModes(modes: string[], access?: Access): this;
    withSpeed(minSpeed?: number, maxSpeed?: number, access?: Access): this;
    clone(): Fan;
}
export declare class Climate extends Base {
    ...
    withSystemMode(modes: ThermostatSystemMode[], access?: Access, description?: string): this;
    withRunningState(modes: ThermostatRunningState[], access?: Access): this;
    withRunningMode(modes: ThermostatRunningMode[], access?: Access): this;
    withFanMode(modes: ThermostatFanMode[], access?: Access): this;
    ...
    withPiCoolingDemand(access?: Access): this;
    withControlSequenceOfOperation(modes: ThermostatControlSequenceOfOperation[], access?: Access): this;
    withSetpointChangeSource(access?: Access): this;
    withAcLouverPosition(positions: ThermostatAcLouverPosition[], access?: Access): this;
    /** @deprecated 3.0 - uses wrong casing for some exposes - requires refactoring all weekly schedule logic */
    withWeeklySchedule(modes: ThermostatScheduleMode[], access?: Access): this;
    clone(): Climate;
}
/**
...
export declare const options: {
    ...
    cover_position_percent_fix: () => Binary;
    local_temperature_based_on_sensor: () => Binary;
    unfreeze_support: () => Binary;
};
export declare const presets: {
    ...
    list: (name: string, access: number, itemType: Numeric | Binary | Composite | Text | Enum) => List;
    switch_: () => Switch;
    ...
    presence: () => Binary;
    pressure: () => Numeric;
    programming_operation_mode: (values?: ThermostatProgrammingOperationMode[]) => Enum;
    setup: () => Binary;
    schedule: () => Binary;
    ...
    tamper: () => Binary;
    temperature: () => Numeric;
    temperature_sensor_select: (sensorNames: string[]) => Enum;
    test: () => Binary;
    ...
    window_detection_bool: (access?: number) => Binary;
    window_open: (access?: number) => Binary;
    moving: () => Binary;
    x_axis: () => Numeric;
    y_axis: () => Numeric;
    z_axis: () => Numeric;
...
declare const eBinary: (name: string, access: number, valueOn: string, valueOff: string) => Binary;
declare const eClimate: () => Climate;
declare const eComposite: (name: string, property: string, access: number) => Composite;
declare const eCover: () => Cover;
...
export { eBinary as binary, eClimate as climate, eComposite as composite, eCover as cover, eEnum as enum, eLight as light, eList as list, eLock as lock, eNumeric as numeric, eSwitch as switch, eText as text, };

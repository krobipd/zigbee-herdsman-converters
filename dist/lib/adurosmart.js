    ...
    const customCluster = m.deviceAddCustomCluster("remoteKey", {
        ...
        commands: {
            reportKey: {
                ...
                ID: 0x00,
                parameters: [
                    { name: "key1Value", type: zigbee_herdsman_1.Zcl.DataType.UINT8 },
                    { name: "key2Value", type: zigbee_herdsman_1.Zcl.DataType.UINT8 },
                    { name: "keyMode", type: zigbee_herdsman_1.Zcl.DataType.UINT8 },
                ],
            },
        },
        commandsResponse: {},
    ...
    const customCluster = m.deviceAddCustomCluster("accelerometerMeasurement", {
        ...
        commandsResponse: {
            reportAccelerometer: {
                ...
                ID: 0x0a,
                parameters: [
                    { name: "attr0Enum", type: zigbee_herdsman_1.Zcl.DataType.UINT16 },
                    { name: "attr0ValueType", type: zigbee_herdsman_1.Zcl.DataType.UINT8 },
                    { name: "accelerometerXValue", type: zigbee_herdsman_1.Zcl.DataType.INT16 },
                    { name: "attr1Enum", type: zigbee_herdsman_1.Zcl.DataType.UINT16 },
                    { name: "attr1ValueType", type: zigbee_herdsman_1.Zcl.DataType.UINT8 },
                    { name: "accelerometerYValue", type: zigbee_herdsman_1.Zcl.DataType.INT16 },
                    { name: "attr2Enum", type: zigbee_herdsman_1.Zcl.DataType.UINT16 },
                    { name: "attr2ValueType", type: zigbee_herdsman_1.Zcl.DataType.UINT8 },
                    { name: "accelerometerZValue", type: zigbee_herdsman_1.Zcl.DataType.INT16 },
                ],
            },
        },
    });
    const convertAcceleration = (value) => Math.round(((value >> 2) * 977) / 1000 + 0.5);
    const fromZigbee = [
        {
...
const iasZoneBinding = () => m.bindCluster({ cluster: "ssIasZone", clusterType: "input" });
...
const extend = {
    contactSensor,
    motionSensor,
    dimmerRemote: () => remote({ 0: "on", 1: "up", 2: "down", 3: "off" }),
    sceneRemote: () => remote({ 0: "toggle", 1: "button_1", 2: "button_2", 3: "button_3" }),
    multiContactSensor,
    multiMotionSensor,
    onOffReporting,
    electricityMeter,

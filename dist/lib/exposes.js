...
exports.options = {
    ...
    invert_cover: () => new Binary("invert_cover", exports.access.SET, true, false).withDescription("Inverts the reported cover position and the state derived from it, false: open=100,close=0, true: open=0,close=100 (default false)."),

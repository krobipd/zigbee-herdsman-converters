...
import { type BinaryArgs, type EnumLookupArgs, type NumericArgs } from "./modernExtend";
...
export declare const ubisysModernExtend: {
    ...
    operationalStatus: (args?: Partial<EnumLookupArgs<"closuresWindowCovering", UbisysClosuresWindowCovering>>) => ModernExtend;
};
export {};

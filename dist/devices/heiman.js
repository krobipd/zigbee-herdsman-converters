        ...
        fromZigbee: [
            {
                cluster: "genBasic",
                type: ["raw"],
                convert: (model, msg, publish, options, meta) => ({ secure: msg.data.toString("hex") }),
            },
        ],
        isModernExtend: true,
    };
...
exports.definitions = [
    ...
    },
    {
        ...
        configure: async (device, coordinatorEndpoint) => {
            ...
            await endpoint.read("heimanClusterSpecial", ["humidityOffset", "temperatureOffset", "shieldingSensorDetection"], {
                manufacturerCode: zigbee_herdsman_1.Zcl.ManufacturerCode.HEIMAN_TECHNOLOGY_CO_LTD,
            });
    ...
    },
    {
        ...
        configure: async (device, coordinatorEndpoint) => {
            ...
            await endpoint.read("ssIasZone", ["zoneStatus", "zoneState", "iasCieAddr", "zoneId"]);
            await endpoint.read("msTemperatureMeasurement", ["measuredValue"]);
            await endpoint.read("heimanClusterSpecial", ["deviceMuteControl", "deviceMuteState", "interconnectable"], {
                manufacturerCode: zigbee_herdsman_1.Zcl.ManufacturerCode.HEIMAN_TECHNOLOGY_CO_LTD,
            });
            await endpoint2.read("msRelativeHumidity", ["measuredValue"]);
        },
    ...
    },
    {
        ...
        configure: async (device, coordinatorEndpoint) => {
            ...
            await endpoint.read("heimanClusterSpecial", ["temperatureOffset", "shieldingSensorDetection"], {
                manufacturerCode: zigbee_herdsman_1.Zcl.ManufacturerCode.HEIMAN_TECHNOLOGY_CO_LTD,
            });
        },
        exposes: [],

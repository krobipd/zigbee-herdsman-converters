    ...
    power_on_behavior: {
        ...
        convert: (model, msg, publish, options, meta) => {
            ...
            if (Object.hasOwn(msg.data, powerOnBehaviorAttribute)) {
                const value = msg.data[powerOnBehaviorAttribute];
    ...
    child_lock: {
        ...
        convert: (model, msg, publish, options, meta) => {
            ...
            if (Object.hasOwn(msg.data, childLockAttribute)) {
                const value = msg.data[childLockAttribute];
...
const tzLocal = {
    ...
    on_with_timed_off: {
        ...
        convertSet: async (entity, key, value, meta) => {
            ...
            if (enforce_child_lock) {
                await entity.write("genOnOff", { [childLockAttribute]: { value: true, type: zigbee_herdsman_1.Zcl.DataType.BOOLEAN } });
            }
    ...
    power_on_behavior: {
        ...
        convertSet: async (entity, key, value, meta) => {
            ...
            const v = utils.getFromLookup(value, lookup);
            await entity.write("genOnOff", { [powerOnBehaviorAttribute]: { value: v, type: zigbee_herdsman_1.Zcl.DataType.ENUM8 } });
    ...
    child_lock: {
        key: ["child_lock"],
        convertSet: async (entity, key, value, meta) => {
            const lookup = { lock: true, unlock: false };
            const v = utils.getFromLookup(value, lookup);
            await entity.write("genOnOff", { [childLockAttribute]: { value: v, type: zigbee_herdsman_1.Zcl.DataType.BOOLEAN } });

            ...
            (device, options) => {
                if (!(0, utils_1.isDummyDevice)(device) &&
                    ...
                    if (args?.endpointName)
                        expose.withEndpoint(args.endpointName);
                    return [expose];
                }
                return [];
            },
...
const nodonIrbFz = {
    irb_holder_temperature_calibration: {
        ...
        convert: (model, msg, publish, options, meta) => {
            if (msg.data.irbHolderTemperatureCalibration === undefined)
                return;
...
const nodonIrbTz = {
    irb_holder_temperature_calibration: {
        ...
        convertSet: async (entity, key, value, meta) => {
            ...
            await entity.write("nodonIrExtender", { irbHolderTemperatureCalibration: raw }, { manufacturerCode: zigbee_herdsman_1.Zcl.ManufacturerCode.NODON });
            return { state: { irb_holder_temperature_calibration: value } };
        },
        convertGet: async (entity, key, meta) => {
            await entity.read("nodonIrExtender", ["irbHolderTemperatureCalibration"], {
    ...
    },
    {
        ...
        exposes: [
            e
                ...
                .withValueMax(10)
                .withValueStep(0.1)
                .withDescription("Extra temperature offset applied on top of localTemperatureCalibration when the IBH-1-1-00 holder " +

...
function customLeakSensor(endpoints) {
    const mes = [];
...
function customWiredLines(endpoints) {
    const mes = [];
            ...
            m.deviceAddCustomCluster("SprutDevice", {
                ...
                attributes: {
                    ...
                    uartBaudRate: {
                        name: "UartBaudRate",
                        ID: 0x6601,
                        type: zigbee_herdsman_1.Zcl.DataType.INT32,
                        min: 1200,
                        max: 115200,
                        default: 9600,
                        write: true,
...
//# sourceMappingURL=teploluxe.js.map
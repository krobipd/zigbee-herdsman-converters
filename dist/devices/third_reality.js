...
exports.definitions = [
    ...
    },
    {
        ...
        ota: true,
        fromZigbee: [exports.fzLocal.scale_weight],
        toZigbee: [
            {
                key: ["reset_button"],
                convertSet: async (entity, key, value, meta) => {
                    const endpoint = meta.device.getEndpoint(1);
                    await endpoint.command("3rScaleSensorcluster", "reset", {}, {});
            ...
            },
            {
                ...
                convertSet: async (entity, key, value, meta) => {
                    const endpoint = meta.device.getEndpoint(1);
                    await endpoint.command("3rScaleSensorcluster", "startReport", {}, {});
            ...
            },
            {
                ...
                convertSet: async (entity, key, value, meta) => {
                    const endpoint = meta.device.getEndpoint(1);
                    await endpoint.command("3rScaleSensorcluster", "stopReport", {}, {});
            ...
            },
            {
                ...
                convertSet: async (entity, key, value, meta) => {
                    ...
                    await endpoint.command("3rScaleSensorcluster", "setWeight", { uint }, {});
            ...
            },
            {
                ...
                convertSet: async (entity, key, value, meta) => {
                    const endpoint = meta.device.getEndpoint(1);
                    await endpoint.command("3rScaleSensorcluster", "convertGramToPoundOunce", {}, {});
        ...
        configure: async (device, coordinatorEndpoint) => {
            ...
            await endpoint.configureReporting("3rScaleSensorcluster", [
                {
                    attribute: { ID: 0x0001, type: zigbee_herdsman_1.Zcl.DataType.INT16 },
        ...
        extend: [
            ...
            m.deviceAddCustomCluster("3rScaleSensorcluster", {
                ...
                ID: 0xff0c,
                attributes: {
                    readWeight: { name: "readWeight", ID: 0x0001, type: zigbee_herdsman_1.Zcl.DataType.INT16 },
                    attr2: { name: "attr2", ID: 0x0002, type: zigbee_herdsman_1.Zcl.DataType.INT16 },
                    attr3: { name: "attr3", ID: 0x0003, type: zigbee_herdsman_1.Zcl.DataType.UINT8 },
                    attr4: { name: "attr4", ID: 0x0004, type: zigbee_herdsman_1.Zcl.DataType.UINT8 },
                    attr5: { name: "attr5", ID: 0x0005, type: zigbee_herdsman_1.Zcl.DataType.INT16 },
                },
                commands: {
                    ...
                    setWeight: { name: "setWeight", ID: 0x03, parameters: [{ name: "uint", type: zigbee_herdsman_1.Zcl.DataType.UINT8 }] },
